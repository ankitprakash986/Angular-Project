...
const transporter = nodemailer.createTransport(sendgridTransport({
  auth:{
    ...
    api_key:'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'
  }
})); 
  ...
  User.findOne({
    ...
    if (existingUser) {
      ...
      return transporter.sendMail({
        to: user.email,
        from:'ankitprakash986@gmail.com',
        subject:'Signup Succesful !',
        html:'<h2>Hi Dopester, <br>We are very happy to see you. <br>Hope to provide you a fantastic user experience.<br> Regards <br> Team Dope !</h2>'
